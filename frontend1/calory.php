...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $gender = isset($_POST['gender']) ? $_POST['gender'] : 'male'; // 'male' or 'female'
    $activityFactor = isset($_POST['activity_factor']) ? floatval($_POST['activity_factor']) : 1.2; // Default activity factor
    ...
    // Calculate daily calorie intake by multiplying BMR with activity factor
    ...
    // Display the result
    header("Location: e.php?calories=$calories");
    exit();
}
?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <div class="single-sidebar">
                ...
                <div class="col-md-8">
                    ...
                    <form id="calory-form" method="post" action="calory.php" enctype="multipart/form-data">
                        <table>
                            <tr>
                                <td><label for="age">Tuổi:</label></td>
                                <td><input type="text" id="age" name="age" min="15" max="80" required></td>
                            </tr>
                            <tr>
                                <td><label for="height">Chiều cao:</label></td>
                                <td><input type="number" class="form-control" id="height" name="height" min="130" max="250" required></td>
                            </tr>
                            <tr>
                                <td><label for="weight">Cân nặng:</label></td>
                                <td><input type="text" id="weight" name="weight" min="30" max="300" required></td>
                            </tr>
                            <tr>
                                <td><label for="gender">Giới tính:</label></td>
                                <td>
                                    Nam <input type="radio" class="form-check-input span1" id="gender" name="gender" value="male">
                                    Nữ <input type="radio" class="form-check-input span1" id="gender" name="gender" value="female">
                                </td>
                            </tr>
                            <tr>
                                <td><label for="activity_factor">Hoạt động:</label></td>
                                <td>
                                    <select class="form-control" id="activity_factor" name="activity_factor">
                                        <option value="1.2">Tỷ lệ trao đổi chất cơ bản (BMR)<</option>
                                        ...
                                        <option value="1.55">Hoạt động tích cực: tập thể dục hàng ngày hoặc tập thể dục cường độ cao 3-4 lần/tuần</option>
                                        <option value="1.725">Rất tích cực: tập thể dục cường độ cao 6-7 lần/tuần</option>
                                        <option value="1.9">Hoạt động tích cực: tập thể dục cường độ cao hàng ngày hoặc công việc thể chất</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
